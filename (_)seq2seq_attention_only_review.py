# -*- coding: utf-8 -*-
"""(_)seq2seq_attention_only_review.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1b13WKs_4tiTAS-W3JAXTg3EehlF4-la4
"""
...
model.fit(x = [encoder_input_train, decoder_input_train], y = decoder_target_train, 
          validation_data = ([encoder_input_test, decoder_input_test], decoder_target_test), 
          batch_size = 128, callbacks=[cp_callback, es], epochs = 30)
...
!mkdir -p saved_model
model.save('review_summaization_12/my_model')
...
model.save('review_summaization_12.h5')
